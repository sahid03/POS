    ...
    <div class="row g-4">
        <div class="col-md-7">
            ...
            <ul class="nav nav-pills gap-1 pb-3 mb-4 border-bottom">
                <li class="nav-item">
                    <a class="nav-link {{ $category == 'Semua' ? 'active' : '' }}" role="button"
                        wire:click="filter('Semua')">Semua</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $category == 'Makanan' ? 'active' : '' }}" role="button"
                        wire:click="filter('Makanan')">Makanan</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $category == 'Minuman' ? 'active' : '' }}" role="button"
                        wire:click="filter('Minuman')">Minuman</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ $category == 'Snack' ? 'active' : '' }}" role="button"
        ...
        <div class="col-md-5">
            <div class="card border-0">
                <div class="card-body px-4">
                    <h4 class="text-dark fw-semibold mb-3">Cart</h4>
