                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $incomes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="align-middle">
                                ...
                                <td><?php echo e($item->cashier->name); ?></td>
                                <td><?php echo e($item->customer_name); ?></td>
                                <td><?php echo e($item->details->count()); ?> Item</td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="fw-semibold">Rp. <?php echo e(number_format($total)); ?></td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Gilang Cendana Awari\Documents\POS\resources\views/pages/admin/incomes/index.blade.php ENDPATH**/ ?>